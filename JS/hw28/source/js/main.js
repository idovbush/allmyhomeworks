...
let myClassRooms = [
  { name: "English", capasity: 15, faculty: "Philology" },
  { name: "Russian", capasity: 14, faculty: "Philology" },
  { name: "Chemistry", capasity: 10, faculty: "Technological" },
  { name: "Phisics", capasity: 16, faculty: "Mechanical" },
  { name: "High-Math", capasity: 12, faculty: "Mechanical" },
...
let myGroup = {name: "ingeneers", capasity: 15, faculty: "Mechanical"}
    ...
    // sortByCapasity(myClassRooms);
        ...
        function sortByABC(anyClassRooms) {
            anyClassRooms.sort((a,b) => {a.name - b.name;
                console.log(b.name)});
                anyClassRooms.forEach((item,index) => {
            console.log(anyClassRooms[index]);
            });
