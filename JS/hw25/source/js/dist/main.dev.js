...
/* let year = +prompt("Enter the year");g
...
var points = 0;
var firstQuestion = +prompt("Who was the first cosmonaut? 1-Gagarin, 2-Leonov, 3-Armstrong.");
var secondQuestion = +prompt("What is the deepest ocean? 1-Pacific, 2-Atlantic, 3-Indian.");
var thirdQuestion = +prompt("When did World War II start? 1-1945, 2-1939, 3-1941.");
if (firstQuestion == 1) points += 2;
if (secondQuestion == 3) points += 2;
if (thirdQuestion == 2) points += 2;
console.log("\u0412\u044B \u043D\u0430\u0431\u0440\u0430\u043B\u0438 ".concat(points, " \u0431\u0430\u043B\u043B\u0430(\u043E\u0432)."));
